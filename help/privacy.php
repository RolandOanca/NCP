...
<head>
    <?php
        include("../config.php");
        $page_title = "Privacy Policy - ".$product_name;
			...
			<div class="container">
				<div class="row">
					<div class="col-12 py-5">
						...
						<p><b><u>Our Company Partners and Sponsors</u></b></p>
						...
						<p><b><u>Online Advertisements</u></b></p>
						...
						<p><b><u>Responses to Email Inquiries</u></b></p>
						...
						<p><b><u>Voluntary Customer Surveys</u></b></p>
						...
						<p><b><u>Browser Level Information</u></b></p>

						<p>The<?php echo $product_name; ?>, Inc. web servers may automatically collect information about a site user's IP address, browser type and the URL that you just came from (whether this URL is on the website or not) and which URL you next go to (whether this URL is on the website or not) by reading this information from the user's browser (information provided by every user's browser). This information is collected in a database and used - in an aggregated, anonymous manner - in our internal analysis of traffic patterns within our website. This information is automatically logged by most websites. The
						<?php echo $product_name; ?>, Inc. may also use a third party to collect information, including through the use of web beacons.</p>

						<p><b><u>Notice of Compliance to California Residents: Your California Privacy Rights Under the California Online Privacy Protection Act and the California Business and Professions Code</u></b></p>
						...
						<p><b><u> Our Company Commitment to Children's Privacy</u></b></p>
						...
						<p><b><u>Our Company's Commitment to Data Security</u></b></p>
						...
						<p><b><u>In the Event of Sale or Bankruptcy</u></b></p>

						<p>The ownership of The	<?php echo $product_name; ?>, Inc. may change at some point in the future. Should that occur, we want this site to be able to maintain a relationship with you. In the event of a sale, merger, public offering, bankruptcy, or other change in control of The
						<?php echo $product_name; ?>, Inc. your information may be shared with the person or business that owns or controls this site. Opting out of receiving information from third parties will not affect our right to transfer your information to a new owner, but your choices will continue to be respected regarding fthe use of your information.</p>

						<p><b><u>Where to Direct Questions about Our Privacy Policy</u></b></p>
						...
						<p><b><u>Types Of Information We Collect</u></b></p>
						...
						<p>Last updated: <?php echo (new DateTime())->modify("first monday of last month")->format("d M Y"); ?></p>
					</div>
				</div>
			</div>
		</section>
