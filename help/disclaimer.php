...
<head>
    <?php
        include("../config.php");
        $page_title = "Disclaimer - ".$product_name;
	...
	<div class="help-wrapper">
		...
		<section>
			<div class="container">
				<div class="row">
					<div class="col-12 py-5">
						<p><b>The website's content and the product for sale is based upon the author's opinion and is provided solely on an "AS IS" and "AS AVAILABLE" basis. You should do your own research and confirm the information with other sources when searching for information regarding health issues and always review the information carefully with your professional health care provider before using any of the protocols presented on this website and/or in the product sold here. Neither <?php echo $payment_gateway; ?> nor the author are engaged in rendering medical or similar professional services or advice via this website or in the product, and the information provided is not intended to replace medical advice offered by a physician or other licensed healthcare provider. You should not construe <?php echo $payment_gateway; ?>'s sale of this product as an endorsement by <?php echo $payment_gateway; ?> of the views expressed herein, or any warranty or guarantee of any strategy, recommendation, treatment, action, or application of advice made by the author of the product.</b></p>
					</div>
				</div>
			</div>
		</section>
		...
		<section>
			<div class="container">
				<div class="row">
					<div class="col-12 py-5">
						<p>
							The <?php echo $product_name; ?> Site (the "Site") is an online
							...
							AND CONDITIONS, YOU MAY NOT ACCESS OR USE THE SITE. <?php echo $product_name; ?> MAY MODIFY
							...
							trademark laws. The owner of the copyrights and trademarks are <?php echo $product_name; ?>,
							...
							grant to <?php echo $product_name; ?> a non-exclusive, royalty-free, worldwide, perpetual
							...
							<?php echo $product_name; ?> by all means and in any media now known or hereafter developed.
							You also grant to <?php echo $product_name; ?> the right to use your name in connection with
							...
							you shall have no recourse against <?php echo $product_name; ?> for any alleged or actual infringement
							or misappropriation of any proprietary right in your communications to <?php echo $product_name; ?>.
							<br>
							<br>
							<b>
								TRADEMARKS.
							...
							are the exclusive trademarks or service marks of <?php echo $product_name; ?>. Other product
							...
							identified as being supplied by <?php echo $product_name; ?>, <?php echo $product_name; ?> does not operate,
							control or endorse any information, products or services on the Internet in any
							way. Except for <?php echo $product_name; ?> - identified information, products or services,
							...
							<?php echo $product_name; ?>. You also understand that <?php echo $product_name; ?> cannot and does not
							...
							INTERNET. <?php echo $product_name; ?> PROVIDES THE SITE AND RELATED INFORMATION "AS
							...
							SERVICE PROVIDED THROUGH THE SERVICE OR ON THE INTERNET GENERALLY, AND <?php echo $product_name; ?> SHALL NOT BE LIABLE FOR ANY COST OR DAMAGE ARISING EITHER DIRECTLY OR
							...
							THE INTERNET GENERALLY. <?php echo $product_name; ?> DOES NOT WARRANT THAT THE SERVICE WILL BE
							...
							ACCESS TO SUCH MATERIALS IS AT YOUR RISK. <?php echo $product_name; ?> HAS NO CONTROL OVER AND
							...
							<br>
							<br>
							IN NO EVENT WILL <?php echo $product_name; ?> BE LIABLE FOR (I) ANY INCIDENTAL, CONSEQUENTIAL,
							...
							DELAY OF SUCH INFORMATION OR SERVICE. EVEN <?php echo $product_name; ?> OR ITS AUTHORIZED
							...
							IN SUCH STATES <?php echo $product_name; ?> LIABILITY IS LIMITED TO THE GREATEST EXTENT PERMITTED BY LAW.
							<br>
							<br>
							<?php echo $product_name; ?> makes no representations whatsoever about any other web site which
							you may access through this one or which may link to this Site. When you access
							a non- <?php echo $product_name; ?> web site, please understand that it is independent from
							<?php echo $product_name; ?>, and that <?php echo $product_name; ?> has no control over the content on that web
							site. In addition, a link to a <?php echo $product_name; ?> web site does not mean that <?php echo $product_name; ?> endorses or accepts any responsibility for the content, or the use, of
							such web site.
							<br>
							<br>
							<b>
							...
							<br>
							You agree to indemnify, defend and hold harmless <?php echo $product_name; ?>, its officers,
							...
							are for the benefit of <?php echo $product_name; ?> and its officers, directors, employees,
							...
							legal action or proceeding between <?php echo $product_name; ?> and you for any purpose concerning this Agreement or the parties’ obligations hereunder shall be brought exclusively in a
							...
							or cause of action arises or such claim or cause of action is barred. <?php echo $product_name; ?> failure to insist upon or enforce strict performance of any provision of this Agreement
							...
							<?php echo $product_name; ?> may assign its rights and duties under this Agreement to any party at any time without notice to you.
							<br>
							<br>
							<br>
